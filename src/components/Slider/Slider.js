...
Rect.prototype.containsPoint = function foo(x, y) {
  return (
    x >= this.x &&
    y >= this.y &&
    x <= this.x + this.width &&
...
/**
 * Sliders reflect a range of values along a bar.
 ...
 * import { Slider, SliderContainer } from 'react-native-paper';
 *
 * const MyComponent = () => (
 *   <View>
